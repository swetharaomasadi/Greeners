          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10), // Spacing between greeting and name
                ...
                SizedBox(height: 10), // Small spacing between name and icon
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color.fromARGB(255, 235, 239, 244),
                    foregroundColor: Colors.black,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10),
                      side: BorderSide(color: const Color.fromARGB(255, 59, 151, 191)),
                    ),
                  ),
                  child: Text(
                    'Edit Dues',
